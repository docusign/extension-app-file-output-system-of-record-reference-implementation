...
variable "application_name" {
  ...
  type        = string
  nullable    = false
  default     = "file-output-system-of-record"
...
variable "application_build_labels" {
  ...
  default = {
    ...
    "org.opencontainers.image.source"      = "https://github.com/docusign/extension-app-file-output-system-of-record-reference-implementation"
...
variable "manifest_files_paths" {
  ...
  type        = list(string)
  default = [
    "../../manifests/authorizationCode/FileOutputOnlyManifest.json",
    "../../manifests/authorizationCode/FileOutputWithDataInputManifest.json",
    "../../manifests/clientCredentials/FileOutputOnlyManifest.json",
    "../../manifests/clientCredentials/FileOutputWithDataInputManifest.json",
  ]
}
